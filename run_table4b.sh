...
# FORGET
# SKIP to get compu. time with T=20
#python jointdiag/tlnmf2_sci_batch.py  -epsnmf 5e-7 -s 100 -itl ?? -pertl 1 -pernmf 10 -runid 8
#
...
##CASE R=1, FORGET python jointdiag/tlnmf2_best_sci_batch.py  -epsnmf 5e-8 -s 100 -itl 500 -pertl 1 -pernmf 1 -nbruns 10

#python jointdiag/tlnmfJD2_sci_batch.py  -s 100 -itl ?? -inmf 200 -epsc 5e-8 -runid 8
